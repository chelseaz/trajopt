...
void PlotPointCloud(OR::EnvironmentBase& env, const Eigen::MatrixXd& x_na, float size, std::vector<OR::GraphHandlePtr>& handles, const OR::RaveVector<float>& color = OR::RaveVector<float>(1,0.5,0.5,1));
